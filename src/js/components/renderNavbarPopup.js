export default function () {
  ...
  <a href="/speakers">
    <div class="navbar-popup-button flex flex-col justify-center items-center m-0 w-full border-t-2 border-solid border-transparent text-center" style="padding: 30px 2%; transition: all 150ms ease 0s; color: white;">
